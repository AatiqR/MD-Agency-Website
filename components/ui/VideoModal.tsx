        ...
        >
          ...
          >
            ...
            <div className="absolute -top-16 left-0 right-0 flex justify-between items-center text-white z-10">
              <motion.h3 
                className="text-xl font-semibold text-green-400 truncate mr-4"
              ...
              <div className="flex items-center space-x-3">
                <motion.button
                  ...
                  className="p-2 bg-black/50 hover:bg-green-500/20 rounded-full border border-green-500/30 hover:border-green-500 transition-all duration-300"
                >
                  {isFullscreen ? (
            ...
            {/* Video Container */}
            <div className="relative w-full bg-black rounded-2xl overflow-hidden shadow-2xl shadow-green-500/20 border border-green-500/20">
              {/* Loading Spinner */}
              <AnimatePresence>
                {isLoading && (
                  <motion.div
                  ...
                  >
                    <div className="text-center">
                      ...
                      />
                      <p className="text-green-400 text-lg font-medium">Loading video...</p>
            ...
            >
              <p className="text-gray-400 text-sm">
                Press <kbd className="px-2 py-1 bg-green-500/20 border border-green-500/30 rounded text-green-400">ESC</kbd> to close
              </p>
            </motion.div>
          </motion.div>
        </motion.div>
